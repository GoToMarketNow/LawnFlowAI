...
export interface IStorage {
  ...
  // Jobs
  getJobs(): Promise<Job[]>;
  getJobsByBusinessId(businessId: number): Promise<Job[]>;
  ...
  // Customers
  getCustomers(businessId: number): Promise<CustomerProfile[]>;
  getCustomer(id: number): Promise<CustomerProfile | undefined>;
  createCustomer(customer: InsertCustomerProfile): Promise<CustomerProfile>;
  updateCustomer(id: number, updates: Partial<InsertCustomerProfile>): Promise<CustomerProfile>;
...
export class DatabaseStorage implements IStorage {
  ...
  async getJobsByBusinessId(businessId: number): Promise<Job[]> {
  ...
  // Customers
  async getCustomers(businessId: number): Promise<CustomerProfile[]> {
    return db
      .select()
  ...
  async getCustomer(id: number): Promise<CustomerProfile | undefined> {
  ...
  async createCustomer(customer: InsertCustomerProfile): Promise<CustomerProfile> {
    const [created] = await db.insert(customerProfiles).values(customer).returning();
    return created;
  }

  async updateCustomer(id: number, updates: Partial<InsertCustomerProfile>): Promise<CustomerProfile> {
    const [updated] = await db
