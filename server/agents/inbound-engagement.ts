...
function isWithinBusinessHours(hours: BusinessProfile["businessHours"]): boolean {
  const now = new Date();
...
function getNextBusinessSlots(hours: BusinessProfile["businessHours"]): Array<{ start_iso: string; end_iso: string; label: string }> {
